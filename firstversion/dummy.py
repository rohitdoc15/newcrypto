import os
import django
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'firstversion.settings')
django.setup()
from firstapp.models import coinname
...
def dbupdt():
    for i in tickerid:
        coin = coinname(name=i, hprice=tickerid[i], currprice=currprice(i), rc=relativeChange(i))
        coin.save()
